...
class RegressionTrainer():
    def __init__(self):
        ...
        #self.__vars = "muons.pt muons.eta muons.ptErr".split()
        ...
        self.__signals = "ggH125"
        # old !H:!V:NTrees=2000::BoostType=Grad:Shrinkage=0.1:SeparationType=RegressionVariance:UseBaggedGrad:GradBaggingFraction=0.7:nCuts=20:MaxDepth=3:NNodesMax=15
    ...
    def train(self):
        ...
        for job in self.__samples:
            ...
            input_file = "../GluGluHToMuMu_M125_13TeV_amcatnloFXFX_pythia8_180930_213715_tuple_all.root"
            ...
            #signals.append(get_tree(train_full_cut))
            #signalsTest.append(get_tree(test_full_cut))
            #train_tree = tree.CopyTree(train_full_cut)
            #test_tree = tree.CopyTree(test_full_cut)
            signals.append(tree)
        ...
        for i, signal in enumerate(signals):
            ...
            print("i : ")
            print(i)
#            loader.AddRegressionTree( signal,  sWeight, ROOT.TMVA.Types.kTraining)
#            loader.AddRegressionTree( signalsTest[i],  sWeight, ROOT.TMVA.Types.kTesting)
...
#           loader.PrepareTrainingAndTestTree(mycut,"nTrain_Regression=500000:nTest_Regression=500000:SplitMode=Random:NormMode=NumEvents:!V")
        self.__apply = []
