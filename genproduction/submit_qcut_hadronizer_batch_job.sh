...
STORAGEDIR=/eos/cms/store/user/bortigno/MadGraph/darkphoton/mzd35/
...
for i in `seq 10 20` ; do bsub -q 1nd -J qcut${i} -o hadronizer_${i}.out -e hadronizer_${i}.err ~/bin/bjob_luncher.sh /afs/cern.ch/work/b/bortigno/sandbox/genproduction/hadronizer/PYTHIA8_Hadronizer_zd2j_mzd35_LHE-GEN-SIM-QCUT_${i}_cfg.py ${WORKINGDIR} ${STORAGEDIR} ; done
